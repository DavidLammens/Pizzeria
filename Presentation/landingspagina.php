...
<body>
    ...
    <main>
        <section id="side">
            <?php include_once __DIR__ . "/modules/landingspagina/gebruikerSide.php" ?>
            <?php include_once __DIR__ . "/modules/landingspagina/winkelmandSide.php" ?>
        </section>

        <section id="main">
            <?php include_once __DIR__ . "/modules/landingspagina/pizzaMenu.php" ?>
        </section>
    </main>
